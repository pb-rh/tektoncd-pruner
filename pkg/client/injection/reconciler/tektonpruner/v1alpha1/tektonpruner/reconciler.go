...
import (
	...
	tektonprunerv1alpha1 "github.com/openshift-pipelines/tektoncd-pruner/pkg/client/listers/tektonpruner/v1alpha1"
	zap "go.uber.org/zap"
...
type reconcilerImpl struct {
	...
	Lister tektonprunerv1alpha1.TektonPrunerLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister tektonprunerv1alpha1.TektonPrunerLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.TektonPruners(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.TektonPruner, desired *v1alpha1.TektonPruner) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.OpenshiftpipelinesV1alpha1().TektonPruners(desired.Namespace)
		...
		updater := r.Client.OpenshiftpipelinesV1alpha1().TektonPruners(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonPruner, desiredFinalizers sets.Set[string]) (*v1alpha1.TektonPruner, error) {
	...
	patcher := r.Client.OpenshiftpipelinesV1alpha1().TektonPruners(resource.Namespace)
